...
import com.amercosovic.mynews.ReadNotifiedSearchedArticle
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.news_row.view.*

class NotifiedSearchedNewsAdapter(private val notifiedNewsResults: List<Doc>) :
    RecyclerView.Adapter<NotifiedSearchedNewsAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.notified_searched_news_row, parent, false)
...
//        Log.d("amer", "SEARCH: ${searchResultsData.multimedia.toString().substringAfter("url=").substringBefore(",")}")
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(holder.itemView.context, ReadNotifiedSearchedArticle::class.java)
